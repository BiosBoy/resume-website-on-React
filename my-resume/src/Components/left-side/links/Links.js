                    ...
                    <div className="info-bullets info-bullets__links-block">
                        <div className="info-bullet info-bullet__links-container">
                            <div className="info-bullet__icon info-bullet__icon-links">
                                <i className="info-bullet__icon-first fab fa-medium fa-2x"></i>
                            </div>
                            <div className="info-bullet__text info-bullet__text-links"><a href="https://medium.com/@svyat770">Medium.com/@svyat770</a></div> 
                        </div>
                        <div className="info-bullet info-bullet__links-container">
                            <div className="info-bullet__icon info-bullet__icon-links">
